<div class="card flex flex-row items-center self-stretch">
	...
	<div class="w-full">
		...
		<div class="h-2.5 rounded-full w-full bg-[#191919]">
			<div class="h-2.5 rounded-full bg-purple-700 w-[55%] animate-[loadMy_1.5s_ease-in-out]" />
		</div>
	</div>
</div>
