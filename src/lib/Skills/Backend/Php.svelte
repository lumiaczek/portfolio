<div class="card flex flex-row items-center self-stretch">
	<div class="mb-5">
		<svg
			...
			viewBox="0 0 256 135"
		>
			<ellipse cx="128" cy="67.3" fill="#FFF" rx="128" ry="67.3" /><ellipse
				cx="128"
				cy="67.3"
				fill="#FFF"
				rx="123"
	...
	<div class="w-full">
		<h3 class="text-xl font-medium">PHP</h3>
		<p class="mb-4" />
		...
		<div class="h-2.5 rounded-full w-full bg-[#191919]">
			<div class="h-2.5 rounded-full bg-purple-700 w-[40%] animate-[loadT_1.5s_ease-in-out]" />
		</div>
	</div>
</div>
