...
<div class="bg-[#181818] sticky top-0 left-0 w-full z-40" role="navigation">
	<nav
		class="w-full px-6 py-4 flex flex-col lg:flex-row justify-between text-white items-center xl:w-[90%] xl:mx-auto 3xl:w-[85%] z-50"
	>
		<div class="flex flex-row justify-between w-full lg:w-fit">
			<h1 class="text-2xl">
				<strong class="text-2xl font-bold text-blue-700">Daniel </strong>Borowski
			</h1>
		...
		<div
			class="lg:flex flex-col lg:flex-row items-center gap-2 text-lg font-normal text-center mt-4 lg:mt-0 shadow-lg rounded-lg w-full p-6 space-y-2 lg:space-y-0 lg:w-fit lg:p-0 lg:shadow-none lg:rounded-none list-none"
			class:hidden={menuHidden}
			class:nav-phone-hidden={!menuHidden}
		>
			<ul class="flex flex-col lg:flex-row ">
				...
				<li
					class:current={$page.url.pathname === '/price'}
					class="py-2 px-4 rounded-lg hover:underline focus:underline"
				>
			...
			<ul class="flex flex-row justify-center items-center space-x-2 px-2 py-4">
				<li>
					<a href="https://github.com/lumiaczek" target="Github" aria-label="Github">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							class="w-7 h-7 fill-white hover:fill-blue-700 transition-all duration-200"
