...
<div class="bg-[#181818] sticky top-0 left-0 w-full z-40" role="navigation">
	...
	>
		...
		<ul
			class="lg:flex flex-col lg:flex-row items-center gap-2 text-lg font-normal text-center mt-4 lg:mt-0 shadow-lg rounded-lg w-full p-6 space-y-2 lg:space-y-0 lg:w-fit lg:p-0 lg:shadow-none lg:rounded-none"
