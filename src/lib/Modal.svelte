...
>
	...
	>
		<div class="border-2 pb-6 rounded-xl border-blue-700 border-opacity-25">
			<h3
				class="flex font-medium text-2xl justify-between items-center p-4 rounded-t-xl bg-blue-700 bg-opacity-25"
			>
				{$service[id - 1].name}
			...
			<div class="mt-3 px-4">
				...
				<div class="flex flex-row justify-center">
					<button
						class="px-8 py-2 mx-auto bg-blue-700 bg-opacity-25 mt-4 rounded-xl text-lg hover:bg-blue-800 hover:bg-opacity-25 font-medium"
						on:click={() => {
							goto('/contact');
